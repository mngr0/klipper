...
# Class to obtain the a CANBus id for a given chip uuid
class CANBusQuery:
    ...
    def __init__(self, reactor, canbus_uuid, canbus_iface='can0'):
        ...
        self.bus = self._open_socket(self.CANBUS_ID_ADMIN_RESP)
    ...
    def _process_data(self, eventtime):
        msg = self.bus.recv(0.)
        if (msg is None or msg.arbitration_id != self.CANBUS_ID_ADMIN_RESP
